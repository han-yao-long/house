<template>
  <div class="join-container">
    ...
    <div class="share-rule">
      ...
      <div class="rule">
        <div class="rule-item">
          <img src="@/assets/hp_pull_new/下单参与@2x.png">
          <div class="rule-text">下单参与</div>
        </div>
        <div class="rule-item">
    ...
    methods:{
      ...
      get_group_manages() {
        ...
        join_get_group_manage(data).then(res => {
          ...
          this.groupDetail.groupExtraRatioAmount=res.data.groupExtraRatioAmount
